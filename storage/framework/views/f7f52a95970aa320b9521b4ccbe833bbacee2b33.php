			...
			<div class="ChiPhiComContent">
				<div class="ChiPhiDetailLeft">
					<table border="0">
                        ...
                        <td align="Right" class="ChiPhiDetailMain"><strong><?php echo e(format($price_data->gia_xe)); ?></strong></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="Right"><strong><?php echo e($price_data->muc_phi); ?> %</strong></td>
						</tr>
						<tr>
							<td width="220" class="ChiPhiDetailItem">Phí</td>
							<td align="Right"><strong><?php echo e(format($price_data->gia_xe * $price_data->muc_phi / 100)); ?></strong></td>
						</tr>
						<tr>
							<td width="220" class="ChiPhiDetailOther"><strong>Lệ phí đăng ký</strong></td>
							<td align="Right"><strong><?php echo e(format($price_data->dang_ky)); ?></strong></td>
						</tr>
						<tr>
							<td width="220" class="ChiPhiDetailOther"><strong>Lệ phí kiểm định</strong></td>
							<td align="Right"><strong><?php echo e(format($price_data->dang_kiem)); ?></strong></td>
						</tr>
						<tr>
							<td width="220" class="ChiPhiDetailOther"><strong>Lệ phí sử dụng đường bộ/năm</strong></td>
							<td align="Right"><strong><?php echo e(format($price_data->duong_bo)); ?></strong></td>
						</tr>
						<tr>
					...
					<div class="ChiPhiTotal">
						<table border="0">
                            ...
                            <td align="Right" class="ChiPhiTotalIn"><strong><?php echo e(format($total)); ?></strong></td>
							</tr>
						</tbody></table>
					</div>
				</div>
				<div class="ChiPhiDetailRight">
                <div class="ChiPhiHinhXe"><img src="<?php echo e($product->image); ?>"></div>
                <div class="ChiPhiTenXe"><?php echo e($product->name); ?></div>
				</div>
				<div class="Clear"></div>
