    ...
    <div class="panel-group" id="accordion" style="padding: 10px">
            ...
            <div class="panel panel-default">
                    <div class="panel-heading menus">
                      ...
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo e($row->id); ?>">
                                <b><?php echo e($row->name); ?></b>
                        </a>
                      </h4>
                    </div>
                <div id="collapse<?php echo e($row->id); ?>" class="panel-collapse collapse content-item">
