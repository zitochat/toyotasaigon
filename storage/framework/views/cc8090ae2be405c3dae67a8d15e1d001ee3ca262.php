        ...
        <section id="main">
           ...
           <p class="title-list">Giới thiệu chung</p>
            <div class="content-container news-content">
                ...
                <?php $__currentLoopData = $general_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class=" news-box horizal-news clearfix" data-wow-delay=".5s">
                        <a href="/gioi-thieu/<?php echo e($row->slug); ?>-<?php echo e($row->id); ?>.html">
           ...
           <div class="wrap_paging">
                    <div class="paging paging_ajax clearfix">
                        <ul class="pages">
                                <?php echo e($general_list->links('frontend.pagination.default')); ?>   
            ...
            <div class="content-container news-content">
                    ...
                    <?php $__currentLoopData = $sales_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class=" news-box horizal-news clearfix" data-wow-delay=".5s">
                            <a href="/gioi-thieu/<?php echo e($row->slug); ?>-<?php echo e($row->id); ?>.html">
               ...
               <div class="wrap_paging">
                        <div class="paging paging_ajax clearfix">
                            <ul class="pages">
                                    <?php echo e($sales_list->links('frontend.pagination.default')); ?>   
                            <div class="clear"></div></ul></div>
                    </div><!--end wrap_paging-->     
                ...
                <div class="content-container news-content">
                   ...
                   <div class="wrap_paging">
                            <div class="paging paging_ajax clearfix">
                                <ul class="pages">
                                        <?php echo e($service_list->links('frontend.pagination.default')); ?>   
                                <div class="clear"></div></ul></div>
                        </div><!--end wrap_paging-->     
