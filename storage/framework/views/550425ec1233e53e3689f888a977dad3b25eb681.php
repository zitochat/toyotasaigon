...
<?php echo $__env->make('frontend.home.product_slider', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('frontend.home.new_post', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
