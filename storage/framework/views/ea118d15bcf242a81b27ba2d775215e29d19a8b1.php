...
<a href="/cpanel_admin/products/<?php echo e($item); ?>/<?php echo e($slug); ?>/add/" style="margin-left: 5px;" class="btn btn-primary">Add new</a><br/>
...
<tr>
    ...
    <td width="60px"><?php echo e(str_limit($row->description, 60)); ?></td>
    <td><?php echo e($row->type); ?></td>

    <td>
    <a class="btn-sm btn-danger" href="/cpanel_admin/products/<?php echo e($item); ?>/<?php echo e($slug); ?>/del/<?php echo e($row->id); ?>">[x]</a>
        <a class="btn-sm btn-success" href="/cpanel_admin/products/<?php echo e($item); ?>/<?php echo e($slug); ?>/edit/<?php echo e($row->id); ?>">[E]</a>
    </td>
</tr>
